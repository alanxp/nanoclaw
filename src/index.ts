...
import { ImageAttachment, parseImageReferences } from './image.js';
  ...
  startIpcWatcher({
    ...
    sendDocument: async (jid, filePath, filename, caption) => {
      ...
      if (channel.sendDocument) {
        await channel.sendDocument(jid, filePath, filename, caption);
      } else {
        // Fallback: notify via text if channel doesn't support documents
        await channel.sendMessage(
          jid,
          caption
            ? `${caption}\n[Document: ${filename}]`
